...
Registry version 1, label schema version 1. 164 labels, 116 materializable. How to read, build and request them: [`labels.md`](labels.md).
...
- **source kind**: deterministic; **role**: context
- **modalities**: audio
- **level**: grid; **dtype**: `fixed_size_list<float32, 4>`; **shape**: `[joint_state]`
- **time**: decision cell k: [t_k, t_k + Δ), t_k = k·Δ
...
- **source kind**: native_annotation; **role**: context
- **modalities**: video
- **level**: grid; **dtype**: `list<fixed_size_list<float32, 4>>`; **shape**: `[participant, box]`
- **time**: decision cell k: [t_k, t_k + Δ), t_k = k·Δ
...
- **source kind**: deterministic; **role**: diagnostic
- **modalities**: video
- **level**: grid; **dtype**: `fixed_size_list<float32, 3>`; **shape**: `[rgb]`
- **time**: decision cell k: [t_k, t_k + Δ), t_k = k·Δ
- **validity**: null where the cell was not fully decoded.
